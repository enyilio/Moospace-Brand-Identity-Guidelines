...
const i18n = {
  zh: {
    ...
    'logo.construction_desc': '以「Moo」字高為基本單位 X。無限符號佔用 3X，字與符號之間的間距為 1X，文字字距 letter-spacing 為 0.5X。所有比例以此為準，不可自行調整間距或大小。',
    'logo.spec1_k': '單位',
    'logo.spec2_k': '符號高度',
  ...
  en: {
    ...
    'logo.construction_desc': 'The height of "Moo" defines the base unit X. The infinity mark occupies 3X. The gap between mark and wordmark is 1X. Letter-spacing on the wordmark is 0.5X. Never alter these proportions.',
    'logo.spec1_k': 'Base unit',
    'logo.spec2_k': 'Mark height',
